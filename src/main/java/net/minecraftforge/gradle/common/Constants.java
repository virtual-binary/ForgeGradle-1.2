...
public class Constants {
    ...
    public static final String MCP_URL          = "https://gregtech.overminddl1.com/fernflower-fix-1.0.zip";
    ...
    public static final String FORGE_MAVEN      = "https://gregtech.overminddl1.com/";
